...
abstract class FlutterFlowTheme {
  ...
  late Color searchBox;
  late Color iconSelected;
  late Color selectedBackGround;
  late Color fabButton;
  late Color appBar;
  late Color sentBox;
  late Color incommingCall;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF00BF2B);
  late Color alternate = const Color(0xFFC8D7E4);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF95A1AC);
  late Color primaryBackground = const Color(0xFF071216);
  late Color secondaryBackground = const Color(0xFF128C7E);
  ...
  late Color searchBox = const Color(0xFF203339);
  late Color iconSelected = const Color(0xFFA6E1BB);
  late Color selectedBackGround = const Color(0x5900BF2B);
  late Color fabButton = const Color(0xFF00BF2B);
  late Color appBar = const Color(0xFF071216);
  late Color sentBox = const Color(0xFF065038);
  late Color incommingCall = const Color(0xFF292929);
}
